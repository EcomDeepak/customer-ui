	...
	<li class="dropdown-content">
		<ul class="dropdown-menu dropdown-navbar">
			<li><a href="#" class="clearfix"> <img
					...
					</span> <span class="msg-time"> <i class="ace-icon fa fa-clock-o"></i>
			...
			<ul class="nav nav-list">
				...
				<li class=""><a href="#" class="dropdown-toggle"> <i
						class="menu-icon fa fa-desktop"></i> <span class="menu-text">
							Agency </span> <b class="arrow fa fa-angle-down"></b>
				</a> <b class="arrow"></b>
						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div>
														...
														<div class="input-group">
															<input class="form-control input-mask-product"
																type="text" id="form-field-mask-3" /> <span
													...
													<div>
														...
														<div>
															<input class="input-medium input-mask-eyescript"
								...
								<h3 class="header smaller lighter blue">
									Checkboxes & Radio <small>All Checkboxes, Radios and
										Switch Buttons Are Pure CSS</small>
								</h3>
								...
								<div class="form-group">
									...
									<div class="controls col-xs-12 col-sm-9">
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<label> <input name="switch-field-1"
													class="ace ace-switch ace-switch-4 btn-rotate"
													...
													<div class="row">
														...
														<div class="col-xs-9 col-md-10">
															<div id="slider-eq">
																...
																<span class="ui-slider-red">55</span> <span
								...
								<div class="row">
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<hr />
													<label for="id-date-range-picker-1">Date Range
														Picker</label>
										...
										<div class="widget-box">
											<div class="widget-header">
												<h4 class="widget-title">
													<i class="ace-icon fa fa-tint"></i> Color Picker
												</h4>
											</div>
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div>
														<label for="simple-colorpicker-1">Custom Color
															Picker</label> <select id="simple-colorpicker-1" class="hide">
									...
									<div class="col-sm-4">
										<div class="widget-box">
											<div class="widget-header">
												<h4 class="widget-title">
													<i class="ace-icon fa fa-tachometer"></i> Knob Input
												</h4>
											</div>
							...
							<h4 class="pink">
								<i class="ace-icon fa fa-hand-o-right green"></i> <a
									...
									data-toggle="modal"> Form Inside a Modal Box </a>
							</h4>
												...
												<form>
													...
													<fieldset>
														<label>Label name</label> <input type="text"
															...
															here.</span> <label class="pull-right"> <input
															type="checkbox" class="ace" /> <span class="lbl">
																check me out</span>
														</label>
													</fieldset>
											...
											<div class="widget-main">
												<form class="form-inline">
													<input type="text" class="input-small"
														...
														class="input-small" placeholder="Password" /> <label
													...
													<div class="row">
														<div class="col-xs-12 col-sm-8">
															<div class="input-group">
																...
																</span> <input type="text" class="form-control search-query"
													...
													<div class="form-group">
														...
														<div>
															<input type="text" id="form-field-first"
																...
																type="text" id="form-field-last" placeholder="Last Name"
																value="Doe" />
														</div>
													</div>
												</div>
